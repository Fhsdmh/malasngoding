...
if (isset($_GET["pesan"])) {
    ...
    if ($pesan == "input") {
        ...
        echo "
            <script>
                alert('Data berhasil diubah di sistem!!');
            </script>        
        ";
    } else  {
        echo "
            <script>
                alert('Data berhasil dihapus di sistem!!');
            </script>        
        ";
    }
...
<body>
    ...
    <h3>Latihan CRUD Malas Ngoding</h3>
    
    <br>

    
    <a href="input.php">Tambah Data Karyawan</a>
<table border="1" cellpadding="10" cellspacing="0">
    ...
    <tr>
		...
		$query_mysql = mysqli_query($conn, "SELECT * FROM user");
        $nomor = 1;
        ?>
	...
	<tr>
		...
		<td>
			...
			<a class="hapus" href="hapus.php?id=<?= $data['id']; ?>" onclick="return confirm('Yakin akan menghapus data??');">Hapus</a>					
		</td>
	</tr>
    <?php } ?>
